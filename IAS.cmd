...
::
::   Homepages: https://github.com/TechyShreyansh/Microsoft-Activation-Scripts-master
...
choice /C:10 /N
if !errorlevel!==2 rem
if !errorlevel!==1 (start https://github.com/TechyShreyansh/Microsoft-Activation-Scripts-master & start %mas%/idm-activation-script & exit /b)
)
)
...
if %_erl%==6 exit /b
if %_erl%==5 start https://github.com/TechyShreyansh/Microsoft-Activation-Scripts-master & start https://massgrave.dev/idm-activation-script & goto MainMenu
